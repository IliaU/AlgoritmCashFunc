...
CREATE TABLE `aks`.`cashfunc_local` (
  ...
  `Is—ustomer` bit(1) NOT NULL DEFAULT b'0',
  `IsDivision` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`Local`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci; 
# 
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `Is—ustomer`, `IsDivision`) VALUES (-1, '¬—≈  ‡ÒÒ˚', 0, 0, 0);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `Is—ustomer`, `IsDivision`) VALUES (1, '–‡ÁÓ‚˚È ÔÓÍÛÔ‡ÚÂÎ¸', 0, 1, 0);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `Is—ustomer`, `IsDivision`) VALUES (2, ' ‡ÒÒ‡ 1', 0, 0, 1);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `Is—ustomer`, `IsDivision`) VALUES (3, ' ‡ÒÒ‡ 2', 0, 0, 1);
...
#
	Insert into `aks`.`CashFunc_Local_Info` (`Local`,	`InfoName`, `About`, `Var1`) Values (1, 'FIO', '‘‡ÏËÎËˇ »Ïˇ ŒÚ˜ÂÒÚ‚Ó', '‘»Œ');
