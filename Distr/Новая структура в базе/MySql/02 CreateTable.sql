...
# 
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `IsÑustomer`, `IsDivision`) VALUES (-1, 'ÂÑÅ Êàññû', 0, 0, 0);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `IsÑustomer`, `IsDivision`) VALUES (1, 'Ðàçîâûé ïîêóïàòåëü', 0, 1, 0);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `IsÑustomer`, `IsDivision`) VALUES (2, 'Êàññà 1', 0, 0, 1);
INSERT INTO `aks`.`cashfunc_local` (`Local`, `LocalName`, `IsSeller`, `IsÑustomer`, `IsDivision`) VALUES (3, 'Êàññà 2', 0, 0, 1);
...
#
	Insert into `aks`.`CashFunc_Local_Info` (`Local`,	`InfoName`, `About`, `Var1`) Values (1, 'FIO', 'Ôàìèëèÿ Èìÿ Îò÷åñòâî', 'ÔÈÎ');
