...
{
    public partial class FListLocalAccounters : Form
    {
        ...
        public FListLocalAccounters()
        {
            try
            {
                ...
                if (this.dtData == null)
                {
                    ...
                    foreach (LocalAccounters item in Com.LocalFarm.CurLocalAccounters)
                    {
                        if (!item.IsDraft)
                        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (LocalAccounters item in LocalFarm.CurLocalAccounters)
                {
                    bool IsDelete = true;
                ...
                for (int i = 0; i < this.dtData.Rows.Count; i++)
                {
                    ...
                    {
                        Local newLocal = LocalFarm.CreateNewLocal("LocalAccounters");
