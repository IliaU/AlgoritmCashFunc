...
namespace AlgoritmCashFunc.BLL.LocalPlg
{
    ...
    /// </summary>
    public class LocalRashPoDocum : Local
    {
        /// <summary>
        ...
        public LocalRashPoDocum(int? Id, string LocalName, bool IsSeller, bool IsСustomer, bool IsDivision, bool IsDraft) : base("LocalRashPoDocum", LocalName, IsSeller, IsСustomer, IsDivision, IsDraft)
        {
            try
            {
                base.Id = Id;
        ...
        /// Конструктор
        /// </summary>
        public LocalRashPoDocum():this(null, Guid.NewGuid().ToString(), false, false, true, true)
        {
            try
            {
            }
