...
namespace AlgoritmCashFunc.BLL.LocalPlg
{
    ...
    /// Бухгалтер
    /// </summary>
    public class LocalAccounters : Local
    {
        /// <summary>
        ...
        public LocalAccounters(int? Id, string LocalName, bool IsSeller, bool IsСustomer, bool IsDivision, bool IsDraft) : base("LocalAccounters", LocalName, IsSeller, IsСustomer, IsDivision, IsDraft)
        {
            try
            {
                base.Id = Id;
        ...
        /// Конструктор
        /// </summary>
        public LocalAccounters():this(null, Guid.NewGuid().ToString(), false, false, true, true)
        {
            try
            {
            }
