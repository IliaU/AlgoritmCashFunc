...
namespace AlgoritmCashFunc.BLL.LocalPlg
{
    ...
    /// Сотрудник
    /// </summary>
    public class LocalEmployees : Local
    {
        /// <summary>
        ...
        public LocalEmployees(int? Id, string LocalName, bool IsSeller, bool IsСustomer, bool IsDivision, bool IsDraft) : base("LocalEmployees", LocalName, IsSeller, IsСustomer, IsDivision, IsDraft)
        {
            try
            {
                base.Id = Id;
        ...
        /// Конструктор
        /// </summary>
        public LocalEmployees():this(null, Guid.NewGuid().ToString(), true, true, false, true)
        {
            try
            {
            }
